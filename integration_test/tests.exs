...
Code.require_file("cases/feature_test/use_feature_test_test.exs", __DIR__)
Code.require_file("cases/feature_test/import_feature_test_test.exs", __DIR__)
Code.require_file("cases/feature_test/automatic_screenshot_test.exs", __DIR__)
